...
async def start(event):
    ...
    await event.reply(
        "━━━━━━━━━━━━━━━━━━━━━━━━\n\nɪ ᴀᴍ ʟᴜᴋʏ ᴛᴏ ᴍᴇɴᴛɪᴏɴ ᴀʟʟ ᴛʜᴇ ɢʀᴏᴜᴘ ᴍᴇᴍʙᴇʀs ɪɴ ᴛᴇʟᴇɢʀᴀᴍ\n ᴛʜᴀɴᴋs ғᴏʀ ᴜsɪɴɢ ʀᴜɴ /help..\n\nɪғ ʏᴏᴜ ʜᴀᴠᴇ ᴀɴʏ ǫᴜᴇsᴛɪᴏɴs ᴛʜᴇɴ\nᴅᴍ ᴛᴏ ᴍʏ [ᴏᴡɴᴇʀ](https://t.me/KyMuraa) ...\n\n━━━━━━━━━━━━━━━━━━━━━━━━",
        link_preview=False,
        buttons=(
            [
                Button.url(
                    "ᴍᴀsᴜᴋɪɴ ɢᴜᴇ ᴋᴇ ɢᴄ ʟᴜ︎︎",
                    "https://t.me/Lukytapibot?startgroup=true",
                ),
            ],
            [
                Button.url("ɢʀᴏᴜᴘ︎︎︎", "https://t.me/Shayri_Music_Lovers"),
                Button.url("ᴄʜᴀɴɴᴇʟ︎︎", "https://t.me/AsadSupport"),
            ],
            [
                Button.url("ᴀʏᴀɴɢ︎︎️️", "https://t.me/Ayyaaaxn),
                Button.url("ʟᴜᴋʏ ɢᴀɴᴛᴇɴɢ", "https://t.me/KyMuraa"),
            ],
        ),
    )
...
async def help(event):
    ...
    if not event.is_private:
        return await event.respond("ᴅᴇᴀʀ sᴛᴀʀᴛ ᴍᴇ ɪɴ ᴘᴍ ᴛᴏ ᴜsᴇ ᴛʜɪs ᴄᴏᴍᴍᴀɴᴅ")
    helptext = "✪ ᴏᴡɴᴇʀ ᴍᴇɴᴜ ᴏғ ʟᴜᴋʏ ᴍᴇɴᴛɪᴏɴ\n\n✪ ᴍʏ ᴏᴡɴᴇʀ ɪs [ʟᴜᴋʏ](https://t.me/KyMuraa)\n✪ ғᴜᴛᴜʀᴇ ᴀɴᴇsᴛʜᴇᴛɪᴄ."
    await event.reply(
        helptext,
        link_preview=False,
        buttons=(
